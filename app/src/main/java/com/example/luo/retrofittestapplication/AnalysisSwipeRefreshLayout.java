...
/**
 *每当用户使用一个向下滑动的手势区刷新页面的时候，都应该使用SwipeRefreshLayout，
 * 当Activity实例化这个View时应该添加一个OnRefreshListener来获取每当滑动刷新手势完成的时候的发送的通知
 * 当手势完成时SwipeRefreshLayout会通知监听者
 ...
 * </p>
 */
public class AnalysisSwipeRefreshLayout  extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = AnalysisSwipeRefreshLayout.class.getSimpleName();
    ...
    /**
     * Simple constructor to use when creating a AnalysisSwipeRefreshLayout from code.
     *
     * @param context
     */
    public AnalysisSwipeRefreshLayout(@NonNull Context context) {
        this(context, null);
    }

    /**
     * Constructor that is called when inflating AnalysisSwipeRefreshLayout from XML.
     *
     * @param context
     * @param attrs
     */
    public AnalysisSwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * Set a callback to override {@link AnalysisSwipeRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link AnalysisSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link AnalysisSwipeRefreshLayout#canChildScrollUp()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent AnalysisSwipeRefreshLayout that this callback is overriding.
         * @param child The child view of AnalysisSwipeRefreshLayout.
         *
         * @return Whether it is possible for the child view of parent layout to scroll up.
         */
        boolean canChildScrollUp(@NonNull AnalysisSwipeRefreshLayout parent, @Nullable View child);
    }
}
